...
bool Sampler::Create()
{
	...
	glSamplerParameteri(m_sampler_handle, GL_TEXTURE_MAG_FILTER, GL_LINEAR_MIPMAP_LINEAR);					   // Default: GL_LINEAR
	...
	glSamplerParameterf(m_sampler_handle, GL_TEXTURE_MIN_LOD, -1000);
	glSamplerParameterf(m_sampler_handle, GL_TEXTURE_MAX_LOD, 1000);
